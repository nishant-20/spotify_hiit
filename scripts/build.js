...
// Crashing if the required files are missing
...
// building production build and print deploy instructions
    ...
    return new Promise((resolve, reject) => {
        compiler.run((err, stats) => {
            ...
            if(messages.errors.length) {
                // the first message itself will give the gist of the issue, others create noise
